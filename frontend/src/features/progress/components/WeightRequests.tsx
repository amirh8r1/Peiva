        ...
        renderItem={(r) => (
          <List.Item style={{ display: 'block', paddingBlock: 10 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
              ...
              {r.status === 'pending'
                ? <StatusTag tone="warning">در انتظار پاسخ</StatusTag>
                : <StatusTag tone="success">پاسخ داده شد</StatusTag>}
            </div>
            ...
            {r.status === 'answered' && r.answer && (
              <div style={{ marginTop: 6 }}>
                ...
                {r.answer.note && (
                  <Text type="secondary" style={{ fontSize: pivaType.caption.fontSize, display: 'block', marginTop: 6 }}>
